<template>
    <div class="p-3">
        <div class="flex justify-between items-center">
            <h2 class="uppercase dark:text-white text-gray-900 text-2xl font-bold">Education</h2>
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form >
                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                            <div>
                                <label for="icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Institution</label>
                                <input v-model="contactInfo.institution" type="text" name="icon"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                            </div>
                            <div>
                                <label for="icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Degree</label>
                                <input v-model="contactInfo.degree" type="text" name="icon"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                            </div>
                            <div>
                                <label for="start" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Year of graduation</label>
                                <input v-model="contactInfo.graduation_year" type="date" name="link" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-[25%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                            </div>
                        </div>
                    ...
                    <table class="w-full text-sm table-auto">
                        <thead class="text-white font-bold text-md uppercase bg-gray-500 ">
                            <tr class="text-left">
                                ...
                                <th scope="col" class="px-4 py-3">Degree</th>
                                <th scope="col" class="px-4 py-3">Year of graduation</th>
                        ...
                        <tbody class="">
                            <tr v-for="el in computedList" :key="el.id" class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">{{el.institution}}</td>
                                <td class="px-4 py-3">{{el.degree}}</td>
                                <td class="px-4 py-3">{{el.graduation_year}}</td>
...
<script setup>
    ...
    const addContact=(evet)=>{
        ...
        const contact = {
            ...
            degree: contactInfo.degree,
            graduation_year: contactInfo.graduation_year
        }
    ...
    const updateContact = (id)=>{
        ...
        contactInfo.institution = foundContact[0].institution
        contactInfo.degree = foundContact[0].degree
        contactInfo.graduation_year = foundContact[0].graduation_year
        toggleModal();
    }
